...
parser.add_argument('--lr', dest='lr', type=float, default=0.00010, help='initial learning rate for adam')
...
parser.add_argument('--checkpoint_dir', dest='checkpoint_dir', default='./checkpoint0910', help='models are saved here')
parser.add_argument('--sample_dir', dest='sample_dir', default='./sample0910', help='sample are saved here')
parser.add_argument('--test_dir', dest='test_dir', default='./test0910', help='test sample are saved here')
...
def main(_):
    ...
    with tf.Session() as sess:
        model = pix2pix(sess, image_size_H=args.fine_size_H,image_size_W=args.fine_size_W, batch_size=args.batch_size,
                        output_size_H=args.fine_size_H,output_size_W=args.fine_size_W, dataset_name=args.dataset_name,
                        L1_lambda=args.L1_lambda,checkpoint_dir=args.checkpoint_dir, sample_dir=args.sample_dir)
